...
import { CreateNFTData, uploadFileToWebStorage } from '../../utils/minter';

type AddNFTsProps = {
  save: (data: CreateNFTData) => Promise<void>;
  address: string;
};
...
const AddNfts = ({ save, address }: AddNFTsProps) => {
